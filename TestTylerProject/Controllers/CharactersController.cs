...
using TestTylerProject.Utilities;
...
namespace TestTylerProject.Controllers
{
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> APICharacter(int id)
        {
            var utility = new IceAndFireUtility();
            var character = await utility.GetCharacter(id);
